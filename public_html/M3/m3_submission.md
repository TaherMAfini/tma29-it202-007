...
<tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Ftma29%2F2023-09-29T15.31.15image.png.webp?alt=media&token=c03f29c1-0e70-41f6-b0f1-ed97b9a7ef9e"/></td></tr>
...
<tr><td> <em>Response:</em> <p>I made the navigation horizontal by changing the display of all &lt;li&gt; under<br>&lt;nav&gt; to inline which put them all on a single line.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 2: </em> Briefly explain how you remove the navigation list item markers</td></tr>
<tr><td> <em>Response:</em> <p>I removed the navigation list markers by setting the &quot;list-style-type&quot; for &quot;nav ul&quot;<br>to none which removed the bullet points.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 3: </em> Briefly explain how you gave the navigation a background</td></tr>
<tr><td> <em>Response:</em> <p>I gave the navigation a background by setting the background-color of the nav<br>element to a shade of green.<br></p><br></td></tr>
...
<tr><td> <em>Response:</em> <p>I made the links change color on hover by setting the color attribute<br>to a shade of orange for all links under nav on hover using<br>&quot;nav a:hover&quot;.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 5: </em> Briefly explain how you changed the challenge list bullet points to checkmarks (✓)</td></tr>
<tr><td> <em>Response:</em> <p>I changed the challenge list bullet points to checkmarks by adding content before<br>each &lt;li&gt; in the ul directly under body using the css attribute content<br>and the selector &quot;body &gt; ul &gt;::before&quot;.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 6: </em> Briefly explain how you made the first character of the h1 tags and anchor tags uppercased</td></tr>
<tr><td> <em>Response:</em> <p>I made the first character of h1 and anchor tags uppercase by using<br>a selector to get the first letter, &quot;h1::first-letter, a::first-letter&quot;, and setting its text-transform<br>attribute to uppercase.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 7: </em> Briefly explain/describe your custom styling of your choice</td></tr>
<tr><td> <em>Response:</em> <p>I added a background color of green to the H1 element using the<br>background-color property and changed the text color to red using the color property.<br>I also underlined the H1 using the text-decoration property with a value of<br>underline.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 8: </em> Briefly explain how the styling for the challenge list doesn't impact the navigation list</td></tr>
<tr><td> <em>Response:</em> <p>The styling for the challenge list doesn&#39;t impact the navigation list because the<br>challenge list styling is applied only to &lt;ul&gt; which is an immediate child<br>of &lt;body&gt; which the navigation list is not since it is a child<br>of &lt;nav&gt; and not &lt;body&gt;.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 9: </em> Briefly explain how you updated the content of the h1 tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>I updated the content of the h1 tag with the link text by<br>attaching an event listener to each link which calls the updateCurrentPage() function with<br>the link text as the parameter. The updateCurrentPage() function then sets the H1<br>tag value to the link text that was passed in. I found all<br>the links using getElementsByTagName(&quot;a&quot;) and got the inner text using innerHTML.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 10: </em> Briefly explain how you updated the content of the title tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>I updated the content of the title tag with the link text by<br>attaching an event listener to each link which calls the updateCurrentPage() function with<br>the link text as the parameter. The updateCurrentPage() function then sets the title<br>tag value to the link text that was passed in. I found all<br>the links using getElementsByTagName(&quot;a&quot;) and got the inner text using innerHTML.<br></p><br></td></tr>
</table></td></tr>
